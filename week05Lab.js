...
console.log(`On July 20th ${person.year}, ${person.firstname} ${person.lastname} was the first person to set foot on earths Moon.`);
 ...
 *
 * ↓ YOUR CODE HERE ↓ */
let myGreeting = new Greeting("jeff", "Ne")
myGreeting.hello()
...
let yourBook = new Book("It", "Steven King");
